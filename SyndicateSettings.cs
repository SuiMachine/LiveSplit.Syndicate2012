...
namespace LiveSplit.Syndicate
{
    public partial class SyndicateSettings : UserControl
    {
        ...
        private const bool DEFAULT_C01_T = true;
        private const bool DEFAULT_C02 = true;
        private const bool DEFAULT_C02_T = true;
        ...
        private const bool DEFAULT_C06_T = true;
        ...
        private const bool DEFAULT_C20 = false;

        public SyndicateSettings()
        {
            InitializeComponent();
            ...
            this.chk01_t.DataBindings.Add("Checked", this, "sC01_T", false, DataSourceUpdateMode.OnPropertyChanged);
            this.chk02.DataBindings.Add("Checked", this, "sC02", false, DataSourceUpdateMode.OnPropertyChanged);
            this.chk02_T.DataBindings.Add("Checked", this, "sC02_T", false, DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.chk06_T.DataBindings.Add("Checked", this, "sC06_T", false, DataSourceUpdateMode.OnPropertyChanged);
        ...
        public XmlNode GetSettings(XmlDocument doc)
        {
            ...
            settingsNode.AppendChild(ToElement(doc, "C1_T", this.sC01_T));
            settingsNode.AppendChild(ToElement(doc, "C2", this.sC02));
            settingsNode.AppendChild(ToElement(doc, "C2_T", this.sC02_T));
            ...
            settingsNode.AppendChild(ToElement(doc, "C6_T", this.sC06_T));
            ...
            settingsNode.AppendChild(ToElement(doc, "C20", this.sC20));
        ...
        public void SetSettings(XmlNode settings)
        {
            ...
            this.sC01_T = ParseBool(settings, "C1_T", DEFAULT_C01_T);
            this.sC02 = ParseBool(settings, "C2", DEFAULT_C02);
            this.sC02_T = ParseBool(settings, "C2_T", DEFAULT_C02_T);
            ...
            this.sC06_T = ParseBool(settings, "C6_T", DEFAULT_C06_T);
